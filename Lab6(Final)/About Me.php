...
<body>
        ...
        <div class="container-fluid"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon" style="background: url(&quot;assets/img/web-lab-high-resolution-color-logo.png&quot;) center / contain;"></span><span>Web Programming Lab</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="About%20Me.php">About Me</a></li>
                </ul>
            </div>
    ...
    <div class="container-fluid" style="background: linear-gradient(120deg, #d6d6d6, white);padding: 20px;">
        <div class="row">
            <div class="col-md-4"><img class="rounded-circle img-fluid" src="assets/img/Profile%20picture%20(2).jpg"></div>
            <div class="col-md-8">
                ...
                <ul class="list-group">
                <li class="list-group-item"><span style="font-size: 20px;"><br><strong>Lab Demostrator(2022 ~ Present)</strong><br>Currently, I serve as a Lab Demonstrator for Web Programming and Mobile Computing courses within the Cognitive Science program at FSKPM, UNIMAS. My role involves guiding students in mastering essential subjects including HTML, CSS, Bootstrap, PHP, SQL, JavaScript, and Laravel for Web Programming, along with Android Studio for Mobile Computing.<br><br></span></li>
