...
<body>
    ...
    <!-- Heading -->
    <h1 class="display-4 fw-bold text-center"><br><strong>Web Programming Lab Feedback Form</strong><br><br></h1>
    ...
    action="action.php" method="POST">
        ...
        <div class="form-group mb-3">
            ...
            value="<?php echo $id_row["username"] ?>" disabled>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            value="<?php echo $id_row["email"] ?>" disabled>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-1" name="lab_resource1" value="Table"><label class="form-check-label" for="lab_resource1">Table</label></div>
            <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-3" name="lab_resource2" value="Chair"><label class="form-check-label" for="lab_resource2">Chair</label></div>
            <div class="form-check"><input class="form-check-input" type="checkbox" id="formCheck-2" name="lab_resource3" value="Computer"><label class="form-check-label" for="lab_resource3">Computer</label></div>
        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q1" value="1"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q1" value="2"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q1" value="3"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q1" value="4"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q1" value="5"></td>
                        </tr>
                        <tr>
                            <td>The course was delivered as outlined in the syllabus.<br></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q2" value="1"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q2" value="2"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q2" value="3"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q2" value="4"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q2" value="5"></td>
                        </tr>
                        <tr>
                            <td>The instructor was organized and prepared for every class<br></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q3" value="1"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q3" value="2"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q3" value="3"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q3" value="4"></td>
                            <td class="text-center" style="vertical-align: middle;"><input type="radio" name="Q3" value="5"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="form-group mb-3">
            ...
            <input class="form-range form-control" type="range" name="experience" min="1" max="100" required>
        </div>

        <!-- Comment -->
        <div class="form-group mb-3">
            <label class="form-label fw-semibold" for="comment">Any comments/suggestions/questions?</label>
            <textarea class="form-control" id="textarea-input-2" name="comment" placeholder="Please fill in your comments here" rows="5"></textarea>
        </div>
